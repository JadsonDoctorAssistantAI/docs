...
<AccordionGroup>
  <Accordion title="API de Consultas" icon="stethoscope">
    ...
    <Link href="/api-reference/consultations">Acceder a referencia</Link>
  </Accordion>
  <Accordion title="API de Exámenes" icon="file-medical">
    ...
    <Link href="/api-reference/exams">Acceder a referencia</Link>
  </Accordion>
  <Accordion title="API de Resúmenes" icon="clipboard-list">
    ...
    <Link href="/api-reference/summaries">Acceder a referencia</Link>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Consultation Recorder" icon="stethoscope">
    ...
    <Link href="/web-components/consultation-recorder">Acceder a referencia</Link>
  </Accordion>
</AccordionGroup>
...
Actualmente, los siguientes eventos pueden ser recibidos:
