...
<AccordionGroup>
  <Accordion title="API de Consultas" icon="stethoscope">
    ...
    <Link href="/api-reference/consultations/comenzar-consulta">Acceder a referencia</Link>
  </Accordion>
  <Accordion title="API de Exámenes" icon="file-medical">
    ...
    <Link href="/api-reference/exams/procesar-exámenes-en-lote">Acceder a referencia</Link>
  </Accordion>
  <Accordion title="API de Resúmenes" icon="clipboard-list">
    ...
    <Link href="/api-reference/summaries/sumarización-de-documentos-[próximamente]">Acceder a referencia</Link>
  </Accordion>
</AccordionGroup>
