...
- `provider`: "MEVO"
- `externalReference`: Identificador único del paciente en el sistema de la plataforma MEVO

```jsx
<daai-consultation-recorder
  apikey="TU_API_KEY"
  professional="ID_DEL_PROFESIONAL"
  prescription-data='{"provider": "MEVO", "externalReference": "ID_DEL_PACIENTE"}'
/>
```