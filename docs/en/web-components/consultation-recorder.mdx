...
<Info>
The prescription data sending functionality (`prescription-data`) is available for test from component version **2.5.0-rc.1**.
</Info>
...
- `provider`: "MEVO"
- `externalReference`: Unique identifier of the patient in the MEVO system

```jsx
<daai-consultation-recorder
  apikey="YOUR_API_KEY"
  professional="PROFESSIONAL_ID"
  prescription-data='{"provider": "MEVO", "externalReference": "PATIENT_ID"}'
/>
```
