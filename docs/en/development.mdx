...
<AccordionGroup>
  <Accordion title="Consultation API" icon="stethoscope">
    ...
    <Link href="/api-reference/consultations">Access reference</Link>
  </Accordion>
  <Accordion title="Exams API" icon="file-medical">
    ...
    <Link href="/api-reference/exams">Access reference</Link>
  </Accordion>
  <Accordion title="Summary API" icon="clipboard-list">
    ...
    <Link href="/api-reference/summaries">Access reference</Link>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Consultation Recorder" icon="stethoscope">
    ...
    <Link href="/web-components/consultation-recorder">Access reference</Link>
  </Accordion>
</AccordionGroup>
...
Currently, the following events can be received:
