...
<AccordionGroup>
  <Accordion title="Consultation API" icon="stethoscope">
    ...
    <Link href="/api-reference/consultations/start-consultation">Access reference</Link>
  </Accordion>
  <Accordion title="Exams API" icon="file-medical">
    ...
    <Link href="/api-reference/exams/process-exams-in-batch">Access reference</Link>
  </Accordion>
  <Accordion title="Summary API" icon="clipboard-list">
    ...
    <Link href="/api-reference/summaries/document-summarization-[coming-soon]">Access reference</Link>
  </Accordion>
</AccordionGroup>
