...
<Info>
A funcionalidade de envio de dados para prescrição médica (`prescription-data`) está disponível para teste a partir da versão **2.5.0-rc.1** do componente.
</Info>
...
- `provider`: "MEVO"
- `externalReference`: Identificador único do paciente no sistema da plataforma MEVO

```jsx
<daai-consultation-recorder
  apikey="SUA_API_KEY"
  professional="ID_DO_PROFISSIONAL"
  prescription-data='{"provider": "MEVO", "externalReference": "ID_DO_PACIENTE"}'
/>
```