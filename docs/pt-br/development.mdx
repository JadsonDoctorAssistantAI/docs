...
<AccordionGroup>
  <Accordion title="API de Consultas" icon="stethoscope">
    ...
    <Link href="/api-reference/consultations/iniciar-consulta">Acessar referência</Link>
  </Accordion>
  <Accordion title="API de Exames" icon="file-medical">
    ...
    <Link href="/api-reference/exams/processar-exames-em-lote">Acessar referência</Link>
  </Accordion>
  <Accordion title="API de Resumos" icon="clipboard-list">
    ...
    <Link href="/api-reference/summaries/sumarização-de-documentos-[em-breve]">Acessar referência</Link>
  </Accordion>
</AccordionGroup>
