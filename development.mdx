...
<AccordionGroup>
  <Accordion title="API de Consultas" icon="stethoscope">
    ...
    <Link href="/apis/consultation/reference">Acessar referência</Link>
  </Accordion>
  <Accordion title="API de Exames" icon="file-medical">
    ...
    <Link href="/apis/exams">Acessar referência</Link>
  </Accordion>
  <Accordion title="API de Resumos" icon="clipboard-list">
    ...
    <Link href="/apis/summary">Acessar referência</Link>
  </Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Consultation Recorder" icon="stethoscope">
    ...
    <Link href="/web-components/consultation">Acessar referência</Link>
  </Accordion>
</AccordionGroup>
